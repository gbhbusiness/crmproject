...
class WhatsappChatbotScript(models.Model):
    ...
    get_image_script = fields.Boolean(string="Get Image Script")
    ...
    is_question_script = fields.Boolean('Is Question Script')

    child_wa_chatbot_id = fields.Many2one(comodel_name="whatsapp.chatbot", string="Child Chatbot")
