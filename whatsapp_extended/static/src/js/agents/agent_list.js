...
export class AgentListPanel extends Component {
    ...
    setup() {
        ...
        if (this.props.thread && this.props.thread.correspondent2){ this.activeID = this.props.thread.correspondent2.id}
        else if (this.props.thread && this.props.thread.correspondents){ this.activeID = this.props.thread.correspondents.id}
        this.viewProps = {
            type: "form",
            buttonTemplate,
